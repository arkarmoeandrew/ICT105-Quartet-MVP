...
| A-08 | Business logic | Students will feel comfortable contacting another student through a private request or messaging feature. | FR-03, FR-11 / US-05 | Medium | Students currently use messaging applications, but the RSU Nexus workflow has not been tested. | Test the Contact Owner and private-message process and collect feedback about clarity and safety. |
