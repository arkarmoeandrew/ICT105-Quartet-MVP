...
export function renderAppFooter() {
  ...
  mount.innerHTML = `<div class="app-container app-footer__inner"><div><a class="app-brand" href="${root}index.html"><img src="${root}assets/logo/rsu-nexus-logo.png?v=20260719-2" alt="" width="36" height="36"><span><b>RSU Nexus</b><small>Campus resource marketplace</small></span></a><p>A student-focused campus resource marketplace designed for the RSU community.</p><p>This student project is not an official university service.</p></div><div><b>Marketplace</b><a href="${root}pages/marketplace.html">Explore resources</a><a href="${root}pages/create-listing.html">Offer a resource</a></div><div><b>Account</b><a href="${root}pages/dashboard.html">Dashboard</a><a href="${root}pages/messages.html">Messages</a></div><div><b>Support</b><a href="${root}index.html#how-it-works">How it works</a><a href="${root}pages/requests.html">Request status</a></div></div><div class="app-container app-footer__bottom">© ${new Date().getFullYear()} RSU Nexus · Built with care for the RSU community.</div>`;
}
